...
:: Android packaging
set AND_CERT_NAME="starlingprojects"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\starlingprojects.p12
...
set IOS_PROVISION=cert\starlingprojects.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=starlingprojects
